...
<!-- Tables -->    
                ...
                <div class="card-body no-padding">
                    <div role="tabpanel">
                        ...
                        <ul role="tablist" class="nav nav-tabs">
                            <li class="active" role="presentation"><a data-toggle="tab" role="tab" aria-controls="watchlist" href="#watchlist">Watchlist</a></li>
                            <li role="presentation"><a data-toggle="tab" role="tab" aria-controls="positive_trend" href="#positive_trend">Positive Trend</a></li>
                            <li role="presentation"><a data-toggle="tab" role="tab" aria-controls="negative_trend" href="#negative_trend">Negative Trend</a></li>
                            <li role="presentation"><a data-toggle="tab" role="tab" aria-controls="neutral_trend" href="#neutral_trend">Neutral Trend</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div id="watchlist" class="tab-pane active" role="tabpanel">
                                <?php include_once('_watchlist.php'); ?>
                            </div>
                            <div id="positive_trend" class="tab-pane" role="tabpanel">
                                <?php include_once('_gainers.php'); ?>
                            </div>
                            <div id="negative_trend" class="tab-pane" role="tabpanel">
                                <?php include_once('_losers.php'); ?>
                            </div>
                            <div id="neutral_trend" class="tab-pane" role="tabpanel">
                                <?php include_once('_neutral.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php include_once('_stock_details.php'); ?>
    <!--
